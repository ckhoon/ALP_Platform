...
angular.
	module('AlpGatewayApp').
		controller('BlePlugController', function($rootScope, $scope,  $http) {
...
angular.
	module('AlpGatewayApp').
		controller('ctrlBlePlugHome', function($rootScope, $scope,  $http) {
...
angular.
	module('AlpGatewayApp').
		controller('ctrlBlePlugShow', function($rootScope, $scope,  $http) {
